...
🧠 How It Works
The user enters a URL in the web interface.
feature.py extracts 30 features from the URL (address-bar, domain, and HTML/JavaScript based features).
The pre-trained model (model.pkl) predicts whether the URL is safe or phishing, along with a confidence score.
The result is displayed to the user, with the option to proceed or stay safe.
🛠️ Tech Stack
Language: Python
Web Framework: Flask
